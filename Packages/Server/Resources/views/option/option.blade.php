    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Danh sách tùy chọn</h4>
                        <div class="new-action float-right" style="padding-top: 13px; margin-bottom: 1.5rem;">
                            <a type="button" class="btn btn-outline-info btn-fw padding-action" href="{{ route('server.option.create.get') }}">Thêm mới tùy chọn</a>
                            <a type="button" class="btn btn-outline-info btn-fw padding-action" href="{{ route('server.option.group.create.get') }}">Thêm mới nhóm tùy chọn</a>
                        </div>
                        <div class="filter-area col-12 col-md-12 col-sm-12 pl-0">
                            ...
                            <div class="form-group col-4 padding-r-15 d-flex align-items-center">
                                <label class="mb-0 pr-2">Chọn nhóm tùy chọn</label>
                            ...
                            <div class="form-group padding-r-15">
                                <div class="input-group">
                                    <input type="text" class="form-control border-radius-15" id="search_option_value" placeholder="Tìm kiếm theo tên tùy chọn" name="Tìm kiếm">
                                </div>
                            </div>
