                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="new-action float-right" style="padding-top: 13px; margin-bottom: 1.5rem;">
                            <a type="button" class="btn btn-outline-info btn-fw padding-action" href="{{ route('server.property.create.get') }}">Create new Property</a>
                            <a type="button" class="btn btn-outline-info btn-fw padding-action" href="{{ route('server.property.group.create.get') }}">Create new Property Group</a>
                        </div>
                        <div class="filter-area col-12 col-md-12 col-sm-12 pl-0">
                            ...
                            <div class="form-group col-4 padding-r-15 d-flex align-items-center">
                                <label class="mb-0 pr-2">Select property group</label>
                            ...
                            <div class="form-group padding-r-15">
                                <div class="input-group">
                                    <input type="text" class="form-control border-radius-15" id="search_property_name" placeholder="Search by property name or property group name" name="search">
                                </div>
                            </div>
