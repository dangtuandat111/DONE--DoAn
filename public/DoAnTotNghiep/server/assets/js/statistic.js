...
"use strict";
/*!**********************************************************!*\
  !*** ./Packages/Server/Resources/assets/js/statistic.js ***!
  \**********************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../js/app */ "./Packages/Server/Resources/assets/js/app.js");
...
function getData() {
  ...
  (0,_js_app__WEBPACK_IMPORTED_MODULE_0__.ajaxWithCsrf)(url, params, function processResponse(res) {
...
function setupChart(datasets, labels) {
  ...
  var chartProd = new Chart(myChart, {
    type: 'bar',
...
function getSellChartData() {
  var url = $('#order_post_sell_chart').val();
  var params = {
    'month': $('#monthSell').val(),
    'year': $('#yearSell').val()
  };
...
function setupSellChart(datasets, labels) {
  ...
  Chart.defaults.global.defaultFontSize = 18;
  Chart.defaults.global.defaultFontColor = '#777';
  var chartProd = new Chart(sellChart, {
    type: 'doughnut',
    // bar, horizontalBar, pie, line, doughnut, radar, polarArea
    data: {
      labels: labels,
...
function getCountData() {
  var url = $('#order_post_count_chart').val();
  (0,_js_app__WEBPACK_IMPORTED_MODULE_0__.ajaxWithCsrf)(url, {}, function processResponse(res) {
    if (res.data.status === true) {
...
function setupCountChart(datasets, labels) {
  ...
  Chart.defaults.global.defaultFontSize = 18;
  Chart.defaults.global.defaultFontColor = '#777';
  var chartProd = new Chart(countChart, {
    type: 'doughnut',
    // bar, horizontalBar, pie, line, doughnut, radar, polarArea
    data: {
      labels: labels,
