...
"use strict";
/*!************************************************************!*\
  !*** ./Packages/Server/Resources/assets/js/order/order.js ***!
  \************************************************************/
__webpack_require__.r(__webpack_exports__);
...
function getOrderDetail() {
  ...
  $(document).find('tr').not(':first').on('dblclick', function () {
    ...
    var currentModal = $('#orderTable');
    getOrderDetailList(order_id, page, function () {
      var optionModal = {};
...
function getOrderDetailList(order_id) {
  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
  var callback = arguments.length > 2 ? arguments[2] : undefined;
  var url = $('#order_detail_list').val();
  var params = {
    'id': order_id,
    'page': page
  };
