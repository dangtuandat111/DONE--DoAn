...
/***/ "./Packages/Client/Resources/assets/js/app.js":
/*!****************************************************!*\
  !*** ./Packages/Client/Resources/assets/js/app.js ***!
  \****************************************************/
...
"use strict";
/*!***************************************************************!*\
  !*** ./Packages/Client/Resources/assets/js/product_detail.js ***!
  \***************************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./app */ "./Packages/Client/Resources/assets/js/app.js");
...
var product_variant_data = JSON.parse($('#product_data').val());
var current = JSON.parse($('#currentChoose').val());
var current_params = {
  color: current.color,
  size: null,
  width: null
...
$(document).ready(function () {
  ...
  var button_size = $('.select_size').find('button');
  var _iterator = _createForOfIteratorHelper(button_size),
    _step;
  try {
    for (_iterator.s(); !(_step = _iterator.n()).done;) {
      var button_size_item = _step.value;
  ...
  var button_width = $('.select_width').find('button');
  var _iterator2 = _createForOfIteratorHelper(button_width),
    _step2;
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var button_width_item = _step2.value;
...
function sizeFindData() {
  ...
  for (var i = 0; i < product_variant_data.length; i++) {
    ...
    if (product_variant_data[i].color == current_params.color && product_variant_data[i].size == current_params.size) {
      suit_width = suit_width + product_variant_data[i].width;
    }
  }
  console.log(current_params);
  console.log(product_variant_data);
  var button_color = $('.select_color').find('button');
  var _iterator3 = _createForOfIteratorHelper(button_color),
    _step3;
  try {
    for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
      var button_color_item = _step3.value;
  ...
  var button_width = $('.select_width').find('button');
  var _iterator4 = _createForOfIteratorHelper(button_width),
    _step4;
  try {
    for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
      var button_width_item = _step4.value;
      if (!suit_width.includes($(button_width_item).attr('value'))) {
        $(button_width_item).addClass('disabled');
      } else {
...
function withourSizeFindData() {
  ...
  var button_color = $('.select_color').find('button');
  var _iterator5 = _createForOfIteratorHelper(button_color),
    _step5;
  try {
    for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
      var button_color_item = _step5.value;
      if (!suit_color.includes($(button_color_item).attr('value'))) {
        $(button_color_item).addClass('disabled');
      } else {
        $(button_color_item).removeClass('disabled');
  ...
  var button_width = $('.select_width').find('button');
  var _iterator6 = _createForOfIteratorHelper(button_width),
    _step6;
  try {
    for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
      var button_width_item = _step6.value;
      if (!suit_width.includes($(button_width_item).attr('value'))) {
        $(button_width_item).addClass('disabled');
      } else {
        $(button_width_item).removeClass('disabled');
...
function colorFindData() {
  ...
  var suit_width = [];
  var suit_size = [];
  for (var _i = 0; _i < suitable_prod.length; _i++) {
    suit_color = suit_color + suitable_prod[_i].color;
    suit_width = suit_width + suitable_prod[_i].width;
    suit_size = suit_size + suitable_prod[_i].size;
  }
  var button_width = $('.select_width').find('button');
  var _iterator7 = _createForOfIteratorHelper(button_width),
    _step7;
  try {
    for (_iterator7.s(); !(_step7 = _iterator7.n()).done;) {
      var button_width_item = _step7.value;
      if (!suit_width.includes($(button_width_item).attr('value'))) {
        $(button_width_item).addClass('disabled');
      } else {
        $(button_width_item).removeClass('disabled');
  ...
  var button_size = $('.select_size').find('button');
  var _iterator8 = _createForOfIteratorHelper(button_size),
    _step8;
  try {
    for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
      var button_size_item = _step8.value;
      if (!suit_size.includes($(button_size_item).attr('value'))) {
        $(button_size_item).addClass('disabled');
      } else {
...
function changeImage() {
  ...
  if (product_variant_image_data.image.length) {
    ...
    product_variant_image_data.image.forEach(function (image) {
      ...
      var tab_id = 'product-tab-0' + index;
      var element = $('.small-image-list .owl-stage-outer .owl-stage').prepend($('.default-small-image .owl-item').clone().attr('id', 'pd-0' + index));
...
function widthFindData() {
  ...
  console.log(JSON.stringify(suitable_prod));
  var button_color = $('.select_color').find('button');
  var _iterator9 = _createForOfIteratorHelper(button_color),
    _step9;
  try {
    for (_iterator9.s(); !(_step9 = _iterator9.n()).done;) {
      var button_color_item = _step9.value;
      if (!suit_color.includes($(button_color_item).attr('value'))) {
        $(button_color_item).addClass('disabled');
      } else {
        $(button_color_item).removeClass('disabled');
  ...
  var button_size = $('.select_size').find('button');
  var _iterator10 = _createForOfIteratorHelper(button_size),
    _step10;
  try {
    for (_iterator10.s(); !(_step10 = _iterator10.n()).done;) {
      var button_size_item = _step10.value;
      if (!suit_size.includes($(button_size_item).attr('value'))) {
        $(button_size_item).addClass('disabled');
      } else {
        $(button_size_item).removeClass('disabled');
...
function withoutWidthFindData() {
  ...
  var button_color = $('.select_color').find('button');
  var _iterator11 = _createForOfIteratorHelper(button_color),
    _step11;
  try {
    for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
      var button_color_item = _step11.value;
      if (!suit_color.includes($(button_color_item).attr('value'))) {
        $(button_color_item).addClass('disabled');
      } else {
        $(button_color_item).removeClass('disabled');
  ...
  var button_size = $('.select_size').find('button');
  var _iterator12 = _createForOfIteratorHelper(button_size),
    _step12;
  try {
    for (_iterator12.s(); !(_step12 = _iterator12.n()).done;) {
      var button_size_item = _step12.value;
      if (!suit_size.includes($(button_size_item).attr('value'))) {
        $(button_size_item).addClass('disabled');
      } else {
        $(button_size_item).removeClass('disabled');
...
function updateData() {
  if (current_params.size && current_params.color && current_params.width) {
    ...
    for (var i = 0; i < product_variant_data.length; i++) {
      ...
      if (product_variant_data[i].color == current_params.color && product_variant_data[i].size == current_params.size && product_variant_data[i].width == current_params.width) {
    ...
    if (item.discount == 0 || Date.parse(item.end_at) >= new Date().getTime()) {
      ...
      $('.regular-price').text(((100 - item.discount) * $('#prod_price').val() / 100).toFixed(3) + '$');
    }
    ...
    if (item.insole_height) {
      ...
      item.insole_height.forEach(function (ih) {
        var e_clone = $('.default_insole_height_element').clone();
    ...
    if (item.shoelace_color) {
      ...
      item.shoelace_color.forEach(function (sc) {
        var e_clone = $('.default_shoeslace_color_element').clone();
