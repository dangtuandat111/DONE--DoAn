...
"use strict";
/*!*****************************************************!*\
  !*** ./Packages/Client/Resources/assets/js/cart.js ***!
  \*****************************************************/
__webpack_require__.r(__webpack_exports__);
  ...
  $('.table-p-qty').on('change', function () {
    ...
    (0,_app__WEBPACK_IMPORTED_MODULE_0__.ajaxWithCsrf)(url, params, function processResponse(res) {
      if (res.data.status === true) {
        ...
        var price = parseFloat($(that).closest('tr').find('.table-p-price p').text());
        var count = parseFloat($(that).closest('tr').find('.table-p-qty input').val());
